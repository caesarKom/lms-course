      ...
      <div className="order-1 lg:col-span-2">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="space-y-6">
            ...
            <RenderText json={JSON.parse(course.description)} />
          </div>
        </div>
                      ...
                      <div className="p-6 pt-4 space-y-3">
                        {chapter.lesson.map((lesson, index) => (
                          <div
                            ...
                            key={lesson.id}
                          >
                            <div className="flex size-8 items-center justify-center rounded-full bg-background/10 border-2 border-primary/20">
