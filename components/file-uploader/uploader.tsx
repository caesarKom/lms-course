...
export const Uploader = ({ value, onChange, fileTypeAccepted }: Props) => {
  ...
  const uploadFile = useCallback(
    async (file: File) => {
      ...
      try {
        const responsePresigned = await fetch("/api/s3/upload", {
          method: "POST",
        ...
        const { presignedUrl, key } = await responsePresigned.json();
